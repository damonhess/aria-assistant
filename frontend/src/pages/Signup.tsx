  ...
  return (
    <div className="flex min-h-screen">
      <motion.div
        ...
        className="hidden lg:flex lg:w-[40%] relative bg-gradient-to-br from-cyan-400 via-blue-500 to-blue-600 p-12 flex-col justify-between overflow-hidden"
      >
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/90">
              <li className="flex items-center gap-3">
                ...
                <span>Intelligent conversations powered by advanced AI</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span>Secure file handling and analysis</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
          ...
          <div className="backdrop-blur-xl bg-card/50 border border-border rounded-2xl p-8 shadow-xl">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Start your journey with ARIA today
              </p>
            </div>
